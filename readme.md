...
![Swagger](https://github.com/Cristiantovar8/gestion-tareas/blob/master/src/docs/swagger.png)

Probar con Postman:

En postman importar la coleccion: **API REST NODE.postman_collection.json**

![Postman](https://github.com/Cristiantovar8/gestion-tareas/blob/master/src/docs/postman.png)
